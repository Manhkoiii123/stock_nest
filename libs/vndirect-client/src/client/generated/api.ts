  ...
  return {
    ...
    async getNews(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<GetNews200Response>
    > {
...
export const NewsApiFactory = function (
  ...
  return {
     ...
     */
    getNews(
      requestParameters: NewsApiGetNewsRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<GetNews200Response> {
      return localVarFp
        .getNews(
 ...
 * @export
 */
export const StockApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getStocks(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['StockApi.getStocks']?.[localVarOperationServerIndex]
          ?.url;
      return (axios, basePath) =>
        createRequestFunction(
          localVarAxiosArgs,
 ...
 * @export
 */
export const StockApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class StockApi extends BaseAPI {
  ...
  public getStocks(options?: RawAxiosRequestConfig) {
    return StockApiFp(this.configuration)
      .getStocks(options)
